...
class MockToiletDb {
  ...
  static final List<DynamicMap> all = [
    ...
    _t(
        ...
        score: 4.2,
        comment: 9,
        operationTime: '05:00 ~ 24:00'),
    _t(
        id: 305,
        folderIds: [3],
        name: '성산대교 남단 공중화장실',
        address: '서울 마포구 성산로 602',
        lat: 37.5527,
        lon: 126.8957,
        score: 3.8,
        comment: 3),
